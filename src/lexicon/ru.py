...
class Lex:
    ...
    ALEAD_ASK_PRIZE_TEXT = (
        "✏️ <b>DIRECTIVE // INITIALIZATION</b>\n"
        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "Введите условия вознаграждения (лимит 512 символов).\n"
        "Данные будут транслироваться всем операторам.\n\n"
        "📡 <code>Ожидание ввода...</code>"
    )
    ALEAD_PRIZE_SAVED = "✅ <b>CORE UPDATED</b>\nДиректива сохранена в ядре."
    ...
    class Academy:
        ...
        CODEX_TEXT = (
            ...
            "Здесь нет легких путей, есть только безупречное исполнение.\n\n"
            "<b>ПРИНИМАЯ КОДЕКС, ТЫ ОБЯЗУЕШЬСЯ:</b>\n"
            "▫ Поставлять только чистый актив\n"
            "▫ Соблюдать дисциплину канала\n"
            "▫ Хранить знания Академии\n\n"
            "<i>Готов ли ты войти в закрытый контур?</i>"
        )

        CODEX_ACCEPT_BUTTON = "✔️ ПРИНЯТЬ КОДЕКС"

        PIN_PROMPT = (
            "🔐 <b>SECURE // PIN SETTINGS</b>\n"
            "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
            "Установите персональный код доступа (4–6 цифр).\n"
            "📡 <code>Ожидание ввода...</code>"
        )

        PIN_CONFIRM_PROMPT = "📡 <code>Повторите ввод кода...</code>"

        PIN_MISMATCH = "✖ <b>ОШИБКА:</b> Коды не совпадают."

        PIN_SUCCESS = "✅ <b>STATUS:</b> Код доступа активирован."
