...
class Submission(Base, TimestampMixin):
    ...
    review_actions: Mapped[List["ReviewAction"]] = relationship("ReviewAction", back_populates="submission", cascade="all, delete-orphan")
    publication: Mapped["PublicationArchive | None"] = relationship("PublicationArchive", back_populates="submission", uselist=False, cascade="all, delete-orphan")
