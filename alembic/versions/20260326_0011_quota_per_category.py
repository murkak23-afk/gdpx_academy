"""Per-category daily seller quotas (one row per user, category, day).
...
def upgrade() -> None:
    ...
    op.create_index("ix_seller_daily_quotas_category_id", "seller_daily_quotas", ["category_id"], unique=False)
